      ...
      <table v-else class="w-full text-left border-collapse">
        <thead>
          <tr class="bg-gray-50/50 border-b border-gray-100">
            <th
              class="py-4 px-6 font-semibold text-gray-600 text-sm uppercase tracking-wider"
            >
              ID
            </th>
            <th
            ...
            <th
              class="py-4 px-6 font-semibold text-gray-600 text-sm uppercase tracking-wider text-right"
            >
              Thao tác
            </th>
          </tr>
        ...
        <tbody class="divide-y divide-gray-100 text-sm">
          ...
          >
            ...
            <td class="py-3 px-6">
              ...
              >
              <span
                class="px-2 py-1 bg-red-100 text-red-700 rounded-md text-xs font-semibold"
                v-else
                >Đã ẩn</span
              >
            </td>
            <td class="py-3 px-6 text-right">
              <button
                ...
                class="text-blue-600 hover:text-blue-800 p-1 mr-2 rounded hover:bg-blue-50 transition-colors"
                title="Sửa"
              >
                <span class="material-symbols-outlined text-[20px]">edit</span>
              </button>
              <button
                @click="deleteCategory(cat.danhmuc_id)"
    ...
    >
      ...
      >
        ...
        <div class="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              v-model="form.slug"
              type="text"
              class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all font-mono text-sm"
              placeholder="nhap-ten-slug"
            />
          </div>
        ...
        >
          <button
            @click="showModal = false"
            class="px-5 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 rounded-lg transition-colors"
          >
            Hủy
          </button>
          <button
            @click="saveCategory"
            class="px-5 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 shadow-sm rounded-lg transition-colors"
          >
            Lưu lại
          </button>
        </div>
