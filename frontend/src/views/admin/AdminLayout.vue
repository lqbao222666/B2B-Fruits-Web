...
<template>
  <div class="admin-root">
    ...
    <aside
      class="admin-sidebar"
      :class="{ 'admin-sidebar--closed': !isSidebarOpen }"
    >
      ...
      <div class="sidebar-nav">
        ...
        <div class="nav-group-title" v-if="isSidebarOpen">
          QUẢN LÝ GIAO DỊCH
        </div>
        ...
        <RouterLink
          to="/admin/products"
          class="nav-item"
          :class="{ 'nav-item--active': route.name === 'admin-products' }"
        >
        ...
        <RouterLink
          to="/admin/nhu-cau"
          class="nav-item"
          :class="{ 'nav-item--active': route.name === 'admin-nhucau' }"
        >
          <span class="material-symbols-outlined nav-icon">assignment</span>
          <span v-if="isSidebarOpen" class="nav-text">Nhu cầu thu mua B2B</span>
        </RouterLink>

        <RouterLink
          to="/admin/categories"
          class="nav-item"
          :class="{ 'nav-item--active': route.name === 'admin-categories' }"
        >
        ...
        <RouterLink
          to="/admin/orders"
          class="nav-item"
          :class="{ 'nav-item--active': route.name === 'admin-orders' }"
        >
        ...
        <RouterLink
          to="/admin/accounts"
          class="nav-item"
          :class="{ 'nav-item--active': route.name === 'admin-accounts' }"
        >
          <span class="material-symbols-outlined nav-icon">group</span>
          <span v-if="isSidebarOpen" class="nav-text"
            >Doanh nghiệp / Nông dân</span
          >
        </RouterLink>
      </div>
