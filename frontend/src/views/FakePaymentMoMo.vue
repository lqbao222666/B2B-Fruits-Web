...
<template>
  <div
    class="min-h-screen bg-[#f2f2f2] flex items-center justify-center p-4 font-inter"
  >
    <div
      class="max-w-[400px] w-full bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-slate-100"
    >
      <div class="bg-[#A50064] p-6 text-center">
        <img
          src="https://upload.wikimedia.org/wikipedia/vi/f/fe/MoMo_Logo.png"
          class="h-12 mx-auto mb-2 brightness-0 invert"
          alt="MoMo Logo"
        />
        <h2
          class="text-white text-sm font-bold uppercase tracking-widest opacity-90"
        >
          Thanh toán đơn hàng
        </h2>
      </div>
      ...
      <div class="p-8">
        <div class="text-center mb-8">
          ...
          <p class="text-4xl font-black text-[#A50064]">
            {{ amount.toLocaleString("vi-VN") }}đ
          </p>
        </div>

        <div
          class="bg-white border-2 border-dashed border-slate-200 rounded-[1.5rem] p-6 mb-8 text-center relative"
        >
          <div
            class="absolute -top-3 left-1/2 -translate-x-1/2 bg-white px-4 text-[10px] font-black text-slate-400 uppercase tracking-tighter"
          >
            Mã QR thanh toán
          </div>
          <img
          ...
          />
          <p
            class="text-[11px] font-bold text-slate-500 uppercase tracking-tight"
          >
        ...
        <div class="flex items-start gap-3 bg-slate-50 p-4 rounded-2xl mb-8">
          <span class="material-symbols-outlined text-[#A50064] text-xl"
            >info</span
          >
          <p class="text-[11px] text-slate-500 leading-relaxed font-medium">
            Vui lòng nhấn nút xác nhận sau khi bạn đã quét mã và chuyển tiền
            thành công trên ứng dụng MoMo.
          </p>
        </div>
      ...
      <div class="bg-slate-50 py-4 text-center border-t border-slate-100">
        <p
          class="text-[9px] text-slate-400 font-bold uppercase tracking-widest flex items-center justify-center gap-1"
        >
