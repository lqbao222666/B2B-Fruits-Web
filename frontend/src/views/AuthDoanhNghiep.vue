...
const goStep2 = () => {
  if (!regForm.full_name.trim()) {
    notify.error("Vui lòng nhập họ và tên / tên người đại diện");
    return;
  }
  if (!regForm.ten_cong_ty.trim()) {
...
const handleRegister = async () => {
  ...
  try {
    await auth.RegisterDoanhNghiep({
      ...
      dia_chi: [regForm.dia_chi_cu_the, regForm.phuong_xa, regForm.quan_huyen]
        .filter(Boolean)
        .join(", "),
...
<template>
  <div class="dn-root">
    <!-- ═══════════════ LEFT PANEL ═══════════════ -->
    <div
      class="dn-panel cursor-pointer hover:opacity-95 transition-opacity"
      @click="router.push('/auth/nong-dan')"
    >
      <!-- Decorative blobs -->
      ...
      <RouterLink to="/" class="dn-logo">
        ...
        >
          ...
          <path
            d="M16 22V16C16 12.686 19.134 10 24 10C28.866 10 32 12.686 32 16V22"
            stroke="white"
            stroke-width="3"
      ...
      <div class="dn-image-slot">
        ...
        <div class="dn-placeholder-icon">
          <span class="material-symbols-outlined text-current">business</span>
        </div>
        <p class="dn-placeholder-hint">
          Thêm ảnh minh họa<br />doanh nghiệp tại đây
        </p>
      </div>
      ...
      <div class="dn-tagline">
        ...
        <p>
          Tìm kiếm nguồn hàng chất lượng từ<br />hàng nghìn nông dân uy tín trên
          toàn quốc
        </p>
      </div>
      ...
      <div class="dn-form-inner">
        ...
        <template v-if="mode === 'login' && !isForgot">
          <div class="dn-form-header">
            ...
            <p class="dn-form-sub">
              Tiếp tục tìm kiếm và thu mua nông sản chất lượng
            </p>
          </div>
          ...
          <form @submit.prevent="handleLogin" class="dn-form">
            ...
            <div class="dn-field">
              <div class="dn-label-row">
                ...
                <RouterLink to="/forgot-password" class="dn-forgot"
          ...
          <button
            @click="auth.LoginGoogle('doanh_nghiep')"
            class="dn-btn-google"
          >
            <svg
              width="20"
          ...
          <p class="dn-switch-text">
            Chưa có tài khoản?
            <a href="#" @click.prevent="switchToRegister" class="dn-link"
              >Đăng ký ngay</a
            >
          </p>
        </template>
        ...
        <template v-if="mode === 'login' && isForgot">
          ...
          <p class="dn-switch-text">
            <a href="#" @click.prevent="isForgot = false" class="dn-link"
          ...
          <form @submit.prevent="goStep2" class="dn-form">
            <div class="dn-field">
              <label class="dn-label"
                >Tên người đại diện <span class="dn-required">*</span></label
              >
              <div class="dn-input-wrap">
                <span class="dn-input-icon"
                  ><span class="material-symbols-outlined text-current"
            ...
            <div class="dn-field">
              <label class="dn-label"
                >Tên công ty / Tổ chức <span class="dn-required">*</span></label
              >
              <div class="dn-input-wrap">
                <span class="dn-input-icon"
                  ><span class="material-symbols-outlined text-current"
                ...
                >
                <input
                  v-model="regForm.ten_cong_ty"
                  type="text"
                  required
                  placeholder="Công ty CP Nông Sản Á Âu"
                  class="dn-input"
                />
              </div>
            </div>
            ...
            <div class="dn-field">
              <label class="dn-label"
                >Email doanh nghiệp <span class="dn-required">*</span></label
              >
              <div class="dn-input-wrap">
                <span class="dn-input-icon"
                  ><span class="material-symbols-outlined text-current"
            ...
            <div class="dn-field">
              <label class="dn-label"
                >Số điện thoại <span class="dn-required">*</span></label
              >
              <div class="dn-input-wrap">
                <span class="dn-input-icon"
                  ><span class="material-symbols-outlined text-current"
            ...
            <div class="dn-field">
              <label class="dn-label"
                ...
                <span class="dn-required">*</span></label
              >
              <LocationSelector
            ...
            <div class="dn-field">
              <label class="dn-label"
                >Mật khẩu <span class="dn-required">*</span></label
              >
              <div class="dn-input-wrap">
                <span class="dn-input-icon"
                  ><span class="material-symbols-outlined text-current"
            ...
            <div class="dn-field">
              <label class="dn-label"
                >Xác nhận mật khẩu <span class="dn-required">*</span></label
              >
              <div class="dn-input-wrap">
                <span class="dn-input-icon"
                  ><span class="material-symbols-outlined text-current"
            ...
            <div class="dn-info-box">
              ...
              >
              <span
                >Sau khi đăng ký, tài khoản doanh nghiệp sẽ được Admin xét
                duyệt. Bạn sẽ nhận thông báo qua email khi được duyệt.</span
              >
            </div>

            <button type="submit" class="dn-btn-primary">Tiếp tục →</button>
          </form>

          <p class="dn-switch-text">
            Đã có tài khoản?
            <a href="#" @click.prevent="switchToLogin" class="dn-link"
              >Đăng nhập</a
            >
          </p>
        </template>
        ...
        <template v-if="mode === 'register' && step === 2">
          ...
          <div class="dn-confirm-card">
            ...
            <div class="dn-confirm-row">
              ...
              <span class="dn-confirm-value dn-role-biz-tag"
                ><span class="material-symbols-outlined text-current"
                  >business</span
                >
                Doanh Nghiệp</span
          ...
          <div class="dn-pending-notice" style="background-color: #f0fdf4; border-color: #bbf7d0; color: #166534;">
            <div class="dn-pending-icon">✅</div>
            <div>
              <strong>Tự động phê duyệt (Mức 2)</strong>
              <p>
                Tài khoản đã được tự động duyệt trực tiếp. Bạn có thể đăng nhập và sử dụng ngay lập tức!
              </p>
            </div>
          </div>
          ...
          <div class="dn-btn-group">
            <button @click="step = 1" class="dn-btn-secondary">
              ← Quay lại
            </button>
            <button
              @click="handleRegister"
              :disabled="loading"
              class="dn-btn-primary dn-btn-flex"
            >
              <span v-if="loading" class="dn-spinner"></span>
