    ...
    <div class="max-w-[1400px] mx-auto px-4 md:px-8 py-12 font-sans">
      ...
      <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8 border-b border-slate-200 pb-6">
        ...
        <div class="flex flex-wrap items-center gap-3 w-full md:w-auto">
          <!-- Nút lọc mobile -->
          <button @click="isCategoryOpen = true" class="lg:hidden w-full sm:w-auto flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-900 text-white px-6 py-3 rounded-2xl font-bold transition-all shadow-md active:scale-95 h-[46px]">
      ...
      <div class="flex flex-col lg:flex-row gap-8 items-start">
        ...
        <aside
          ...
          :class="isCategoryOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
        >
          <div class="p-6 md:p-8 lg:p-6 lg:bg-white lg:rounded-3xl lg:border lg:border-slate-200 lg:shadow-sm">
            ...
            <h3 class="hidden lg:flex font-black text-lg text-slate-800 items-center gap-2 uppercase tracking-tight mb-6">
              <span class="material-symbols-outlined text-[#2E7D32]">category</span>
              Danh mục
            </h3>
        ...
        <main class="flex-1 w-full min-w-0">
          ...
          <div class="flex justify-between items-center mb-6">
             <h2 class="font-bold text-lg text-slate-700 hidden sm:block">Tất cả sản phẩm ({{ filteredAndSortedPosts.length }})</h2>
